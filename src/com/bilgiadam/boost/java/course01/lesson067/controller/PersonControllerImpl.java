...
public class PersonControllerImpl implements PersonController<PersonEntity>, Serializable {
	...
	public void create(PersonEntity entity) {
		try {
			...
			System.out.println("ekleme tamamdýr" + PersonController.class);
		} catch (Exception e) {
			System.out.println("ekleme anýnda hata meydana geldi !!!!! " + PersonController.class);
			e.printStackTrace();
		}
	}
	...
	public void delete(PersonEntity entity) {
		...
		try {
			...
			System.out.println("silme anýnda hata meydana geldi !!!!! " + PersonController.class);
			e.printStackTrace();
		}
	...
	public void update(PersonEntity entity) {
		try {
			...
			System.out.println("güncelleme anýnda hata meydana geldi !!!!! " + PersonController.class);
			e.printStackTrace();
		}
	}
	...
	public PersonEntity find(long id) {
		...
		try {
			...
			System.out.println("find anýnda hata meydana geldi !!!!! " + PersonController.class);
			e.printStackTrace();
		}
		return null;
	}
	...
	public PersonEntity singleResult(long id) {
		return PersonController.super.singleResult(id);
	}
}
